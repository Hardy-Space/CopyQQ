    ...
    public void refreshFinish(int refreshResult)
    {
        ...
        switch (refreshResult)
        {
            ...
            default:
                ...
                refreshStateImageView
                        .setBackgroundResource(R.drawable.refresh_fail);
                break;
        }
        if (pullDownY > 0)
        {
    ...
    public void loadmoreFinish(int refreshResult)
    {
        ...
        switch (refreshResult)
        {
            ...
            default:
                ...
                loadStateImageView.setBackgroundResource(R.drawable.refresh_fail);
                break;
        }
        if (pullUpY < 0)
        {
    ...
    public boolean dispatchTouchEvent(MotionEvent ev)
    {
        switch (ev.getActionMasked())
        {
            ...
            case MotionEvent.ACTION_MOVE:
                //根据拖动的距离和radio变化速率来计算实际的下拉或者上滑的距离
                if (mEvents == 0)
                {
                    if (pullDownY > 0
                ...
                if (pullDownY > 0 || pullUpY < 0)
                    //调用父类方法发出重绘布局请求，会回调重写的onLayout()方法重绘布局
                    requestLayout();
                if (pullDownY > 0)
                {
